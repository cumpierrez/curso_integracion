...
import org.gobcan.prueba.Integraciones.Operaciones;
...
public class OperacionesTest 
{
    ...
    {
    	assertEquals("La division ha dejado de ser correcta", -2, Operaciones.division(-21, 10));
    	assertEquals("La division ha dejado de ser correcta", 10, Operaciones.division(100, 10));
    	assertEquals("La division ha dejado de ser correcta", 0, Operaciones.division(0, 10));
    }    
    
    @Test
    public void pruebaDeDivision5Test()
    {
    	assertEquals("La division ha dejado de ser correcta", 100, Operaciones.division(100, 0));
